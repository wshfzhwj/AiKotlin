...
object FakeNewsDataStore {
    ...
    private val articles = listOf(
        article(
            ...
            imageUrl = "https://example.com/images/tech_news1.jpg",
            category = "technology"
        ),
        article(
            id = "sports_1",
            ...
            imageUrl = "https://example.com/images/sports_news1.jpg",
            category = "sports"
        ),
        article(
            id = "business_1",
            ...
            imageUrl = "https://example.com/images/finance_news1.jpg",
            category = "business"
        ),
        article(
            id = "education_1",
            ...
            imageUrl = "https://example.com/images/education_news1.jpg",
            category = "education"
        ),
        article(
            id = "health_1",
            ...
            imageUrl = "https://example.com/images/health_news1.jpg",
            category = "health"
        ),
        article(
            id = "entertainment_1",
            ...
            imageUrl = "https://example.com/images/entertainment_news1.jpg",
        ...
        article(
            ...
            imageUrl = "https://example.com/images/travel_news1.jpg",
            category = "travel"
        ),
        article(
            id = "auto_1",
            ...
            imageUrl = "https://example.com/images/auto_news1.jpg",
            category = "auto"
        ),
        article(
            id = "general_1",
            ...
            imageUrl = "https://example.com/images/general_news1.jpg",
            category = "general"
        ),
        article(
            id = "science_1",
            ...
            imageUrl = "https://example.com/images/science_news1.jpg",
            category = "science"
        ),
        article(
            id = "business_2",
            ...
            imageUrl = "https://example.com/images/business_news2.jpg",
            category = "business"
        ),
        article(
            id = "technology_2",
            ...
            imageUrl = "https://example.com/images/tech_news2.jpg",
            category = "technology"
        )
    )
    ...
    fun getArticlesByCategory(category: String?): List<NewsArticle> {
        ...
        return articles.filter { it.category == normalized }
    }
